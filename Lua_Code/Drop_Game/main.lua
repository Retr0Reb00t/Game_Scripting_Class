...
function titleLoad()
    slimeFire = love.graphics.newImage("fish_norm.png")
...
function randomizeBubbles()
    ...
    while count > 0 do
        bubbles[#bubbles+1] = math.random(0, love.graphics.getWidth())
        bubbles[#bubbles+1] = math.random(0, love.graphics.getHeight())
...
function drawBubbles(bubbles)
    love.graphics.setColor(math.random(0,127), math.random(0,127), math.random(191, 255), 0.75)
    love.graphics.setPointSize(10)
    love.graphics.points(bubbles)
...
function love.load()
    ...
    slimeF = love.graphics.newImage("fish_norm.png")
